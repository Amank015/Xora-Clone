      ...
      <div className="container">
        ...
        ">
        {
          features.map(({id,icon,caption,title,text,button})=>(
            <div key={id} className=" relative z-2 md:px-10 px-5 md:pb-10 flex-50
            ...
            details.map(({id,icon,title})=>(
              <li key={id} className="relative pt-16 px-4 pb-14">
               <div className=" absolute top-8 bottom-0 left-1/2 bg-s3/20
                w-[1px] h-full z-10
               "/>
               <div className="flex items-center max-auto mb-3 border-2 border-s2 rounded-full hover:border-s4
